...
st.set_page_config(page_title="PulseDesk", page_icon=":material/support_agent:")
...
if not st.session_state.access_token:
    ...
    st.caption("AI-augmented support ticket triage. Sign in or create an account to continue.")
    ...
    with sign_in_tab:
        ...
        if submitted:
            try:
                ...
                st.session_state.role = api_client.decode_role_from_token(tokens["access_token"])
